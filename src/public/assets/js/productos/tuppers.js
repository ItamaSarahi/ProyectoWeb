const mainProduct = (() => {
  ...
  const BASE_URL = "https://creativeideas-d.onrender.com/productos/mostrarTuppers";
  let contador = 0;
  let index = 0;
  ...
  const _actionButtonAgregar = async (event) => {
    ...
    window.location=`https://creativeideas-d.onrender.com/productos/guardarDatosTuppers/${idProducto}/${cantidad}`;
